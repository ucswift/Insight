...
namespace WaveTech.Insight.InsightWpf.Windows
{
	/// <summary>
		...
		public string Description
		{
			get
			{
				return
					...
					Environment.NewLine + Environment.NewLine + "Special Thanks To" + Environment.NewLine +
					"--------------------------" + Environment.NewLine + "Icons By DryIcons.com (http://dryicons.com/)";
